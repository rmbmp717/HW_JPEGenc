...
fn flatten_matrix(matrix: s10[8][8]) -> s10[64] {
  [
    ...
    matrix[6][7], matrix[6][6], matrix[6][5], matrix[6][4], matrix[6][3], matrix[6][2], matrix[6][1], matrix[6][0],
    matrix[5][7], matrix[5][6], matrix[5][5], matrix[5][4], matrix[5][3], matrix[5][2], matrix[5][1], matrix[5][0],
    matrix[4][7], matrix[4][6], matrix[4][5], matrix[4][4], matrix[4][3], matrix[4][2], matrix[4][1], matrix[4][0],
    matrix[3][7], matrix[3][6], matrix[3][5], matrix[3][4], matrix[3][3], matrix[3][2], matrix[3][1], matrix[3][0],
    matrix[2][7], matrix[2][6], matrix[2][5], matrix[2][4], matrix[2][3], matrix[2][2], matrix[2][1], matrix[2][0],
    matrix[1][7], matrix[1][6], matrix[1][5], matrix[1][4], matrix[1][3], matrix[1][2], matrix[1][1], matrix[1][0],
    matrix[0][7], matrix[0][6], matrix[0][5], matrix[0][4], matrix[0][3], matrix[0][2], matrix[0][1], matrix[0][0]
  ]
}
...
fn test0_zigzag_reorder() {
  let reversed_matrix: s10[8][8] = [
    ...
    [ s10:48, s10:47, s10:46, s10:45, s10:44, s10:43, s10:42, s10:41 ],
    [ s10:40, s10:39, s10:38, s10:37, s10:36, s10:35, s10:34, s10:33 ],
    [ s10:32, s10:31, s10:30, s10:29, s10:28, s10:27, s10:26, s10:25 ],
    [ s10:24, s10:23, s10:22, s10:21, s10:20, s10:19, s10:18, s10:17 ],
